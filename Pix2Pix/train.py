...
def main():
    ...
    train_dataset = FacadesDataset(list_file='/home/SA24001013/DIP/Assignments/02_DIPwithPyTorch/Pix2Pix/night2day/datasets/train_list.txt')
    val_dataset = FacadesDataset(list_file='/home/SA24001013/DIP/Assignments/02_DIPwithPyTorch/Pix2Pix/night2day/datasets/val_list.txt')
